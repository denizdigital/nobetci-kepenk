...
import Script from 'next/script'; // GA4 İÇİN NEXT/SCRIPT EKLENDİ
...
export default function Home() {
        ...
        if (gclid || gbraid || wbraid || gad_source) {
          ...
          setTimeout(async () => {
            ...
            if (data.status && data.status.includes('SALDIRGAN')) {
              ...
              // Zehirli Ok (Google'a Bildir - GA4 Kodu Aktif)
  ...
  return (
    <>
      {/* --- GA4 ANA KURULUM SCRİPTLERİ (BURASI EKLENDİ) --- */}
      <Script 
        src="https://www.googletagmanager.com/gtag/js?id=G-E5LFKT77Q3" 
